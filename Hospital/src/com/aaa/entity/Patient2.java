...
public class Patient2 implements java.io.Serializable {
	...
	private Set examineresults = new HashSet(0);
	...
	public Patient2(String patientname3, String sex4, Date birthdayDay, String idnumber, Integer phone4, String nation3,
			...
			String personalIllness, String familyIllness, Integer medicalRecord, Set charges, Set chineseprescribes,
			Set contactpersons, Set subscribes, Set icclips, Set westernprescribes, Set examineorders,
			Set examineresults, Set medicalrecords) {
		...
		this.examineresults = examineresults;
	...
	public Set getExamineresults() {
		return this.examineresults;
	}

	public void setExamineresults(Set examineresults) {
		this.examineresults = examineresults;
	}
